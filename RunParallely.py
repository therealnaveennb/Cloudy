...
model = load_model(r"C:\Users\VARGHESE SHRINOJ\Desktop\WakeWordDetection-master\saved_model\WWD2.h5")
...
def prediction_thread(y):
     pred_thread = threading.Thread(target=prediction, name="PredictThread ", args=(y,))
     pred_thread.start()
